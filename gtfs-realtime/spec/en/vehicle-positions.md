...
The trip that the vehicle is currently serving should be given through a [trip descriptor](/transit/gtfs-realtime/reference.html#TripDescriptor). You can also provide a [vehicle descriptor](/transit/gtfs-realtime/reference.html#VehicleDescriptor), which specifies a precise physical vehicle that you are providing updates about. Documentation is provided below.
