...
| `amount` | Currency amount | **Required** | The cost of the transfer rule. May be negative to represent transfer discounts. |
| `currency` | Currency code | **Required** | The currency of the cost of the transfer rule. |
