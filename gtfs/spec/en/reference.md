...
|  `bike_pickup_type` | Enum | Optional | Indicates bike pickup allowance. Valid options are:<br><br>`0` or empty - No information for bike pickup allowance<br>`1` - Bicycle pickup allowed.<br>`2` - No bicycle pickup allowed. |
|  `bike_drop_off_type` | Enum | Optional | Indicates bike drop off allowance. Valid options are:<br><br>`0` or empty - No information for drop off allowance.<br>`1` - Bicycle drop off allowed.<br>`2` - No bicycle drop off allowed.<br>`3` - Bicycles must drop off. |
