...
|  `trip_route_type` | Enum | **Optional** | Identifies the type of transportation of the trip if it is not the same as the route. See the definition of `route_type` in [routes.txt](#routestxt) for the values. |
