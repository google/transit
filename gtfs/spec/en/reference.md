...
|  Field Name | Type | Required | Description |
|  ------ | ------ | ------ | ------ |
|  `stop_id` | ID | **Required** | Identifies a location: stop, station, entrance etc. (see `location_type` for the full list). <br><br> The term "station entrance" refers to both station entrances and station exits. Multiple routes may use the same stop. |
