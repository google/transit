...
|  `tts_agency_name` | Text | Optional | Readable version of the `agency_name`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
...
|  `tts_route_short_name` | Text | Optional | Readable version of the `route_short_name`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
...
|  `tts_route_long_name` | Text | Optional | Readable version of the `route_long_name`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
...
|  `tts_trip_headsign` | Text | Optional | Readable version of the `trip_headsign`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
...
|  `tts_trip_short_name`| Text | Optional | Readable version of the `trip_short_name`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
...
|  `tts_stop_headsign` | Text | Optional | Readable version of the `stop_headsign`. See "Text-to-speech field" in the [Term Definitions](#term-definitions) for more. |
