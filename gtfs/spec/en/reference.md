...
|  `stop_doors` | Enum | Optional | Indicates the type of platform doors installed at this stop. Valid options are: <br><br>`0` - No doors installed<br>`1` - Full Height Doors or Screen<br>`2` - 3/4 Height Doors or Screen<br>`3` - Half Height Doors or Screen<br>`4` - Full Height Fence or Panel<br>`5` - 3/4 Height Doors or Screen<br>`6` - Half Height Doors or Screen<br>`7` - Under Construction<br>`8` - Partially Out of Order<br>`9` - Completely Out of Order |
