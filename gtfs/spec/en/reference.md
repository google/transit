...
|  stop_name | **Required** | The **stop_name** field contains the name of a stop, station, or station entrance. Please use a name that people will understand in the local and tourist vernacular, and avoid abbreviations. The stop name should not contain symbols, or the stop_id. |  |  |
...
| | | Note: Stops less than 2m away should be matched by a parent/child relationship. Similarly, parent-child stops should ideally not be more than 1 km away. |
...
|   |  | 07:40:00 P.M. | 19:40:00 |
|   |  | 01:55:00 A.M. | 25:55:00 |
|   |  | **Notes:** <br /> 1. Trips that span multiple dates will have stop times greater than 24:00:00. For example, if a trip begins at 10:30:00 p.m. and ends at 2:15:00 a.m. on the following day, the stop times would be 22:30:00 and 26:15:00. Entering those stop times as 22:30:00 and 02:15:00 would not produce the desired results. <br /><br /> 2. Every **departure_time** should always increase along a given trip, and specify times in the associated agency timezone values for consistency across the trip. Thus the reference timezone for times specified in a trip does not change.  |  |
