...
|  feed_id | Optional | The feed publisher can specify an alphanumeric identifier that uniquely specifies this feed. This is intended to allow applications that consume multiple feeds to disambiguate entities. **feed_id** should be stable across versions of the same feed, and ideally globally unique. |