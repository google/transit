...
* **Readable field** - The field should contain the same information that its parent field (on which it falls back if it is empty). It is aimed to be read as text-to-speach, therefore, abbreviation should be either removed ("St" should be either read as "Street" or "Saint"; "Dr" should be "Drive" or "Doctor") or kept to be read as it ("JFK Airport" is said abbreviated).
...
|  readable_agency_name | **Optional** | Readable version of the **agency_name**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_stop_name | **Optional** | Readable version of the **stop_name**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_route_short_name | **Optional** | Readable version of the **route_short_name**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_route_long_name | **Optional** | Readable version of the **route_long_name**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_trip_headsign | **Optional** | Readable version of the **trip_headsign**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_trip_short_name | **Optional** | Readable version of the **trip_short_name**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
...
|  readable_stop_headsign | **Optional** | Readable version of the **stop_headsign**. See "Readable field" in the [Term Definitions](#term-definitions) for more. |  |  |
